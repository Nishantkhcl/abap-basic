...
TYPES : BEGIN OF t_content,
          line(255),
        END OF t_content.
DATA:it_index_new       TYPE STANDARD TABLE OF zgit_hana_gi_index,
     ls_index_new       TYPE                   zgit_hana_gi_index,
     gs_index_new       TYPE                   zgit_hana_gi_index,
     ls_final           TYPE                   zgit_hana_output,
     gt_results         TYPE STANDARD TABLE OF zgit_hana_output,
     lt_final           TYPE STANDARD TABLE OF zgit_hana_output,
