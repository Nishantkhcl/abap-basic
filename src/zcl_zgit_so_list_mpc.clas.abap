class ZCL_ZGIT_SO_LIST_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZGIT_SO_LIST_MPC==========CP' ##NO_TEXT.
...
CLASS ZCL_ZGIT_SO_LIST_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGIT_SO_LIST_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGIT_SO_LIST_MPC=>TS_SALESORDER' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGIT_SO_LIST_MPC=>TS_SALESORDERITEM' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20220407185339'.                  "#EC NOTEXT
